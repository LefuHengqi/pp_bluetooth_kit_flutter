//
//  PPBluetoothLorreDataAnalysis.h
//  PPBluetoothKit
//
...
@interface PPBluetoothLorreDataAnalysis : NSObject
...
+ (void)lorreDealWithMemberIdAndUserId:(NSString *)reciveStr settingModelArray:(NSMutableArray *)array;
